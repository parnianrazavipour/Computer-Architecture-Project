...
VL_ATTR_COLD void Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__adder__5(Vmips_machine_add_sub_mul_div* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmips_machine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__adder__5\n"); );
    // Init
...
VL_ATTR_COLD void Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__adder__9(Vmips_machine_add_sub_mul_div* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmips_machine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__adder__9\n"); );
    // Init
...
VL_ATTR_COLD void Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__divider__12(Vmips_machine_add_sub_mul_div* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmips_machine__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vmips_machine_add_sub_mul_div___settle__TOP__mips_machine__DOT__core__DOT__f_core__DOT__alu__DOT__divider__12\n"); );
    // Init
    IData/*23:0*/ M__DOT____Vcellout__ADD23__sum;
    CData/*0:0*/ __PVT__M__DOT__ADD23__DOT__ctemp1;
    CData/*0:0*/ __PVT__M__DOT__ADD23__DOT__ctemp2;
